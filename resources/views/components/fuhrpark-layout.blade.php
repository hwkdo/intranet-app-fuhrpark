...
@php
    $defaultNavItems = [
        ...
        ['label' => 'Benachrichtigungen', 'href' => route('apps.fuhrpark.settings.notifications'), 'icon' => 'bell', 'description' => 'Benachrichtigungen dieser App konfigurieren', 'buttonText' => 'Benachrichtigungen öffnen'],
