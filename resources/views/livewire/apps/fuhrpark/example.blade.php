...
title('Fuhrpark - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die Fuhrpark App',
    'status' => 'active',
...
<x-intranet-app-fuhrpark::fuhrpark-layout heading="Beispiel-Seite" subheading="Demonstration der Fuhrpark-Funktionalität">
    <flux:card>
